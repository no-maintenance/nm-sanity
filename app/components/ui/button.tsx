...
const buttonVariants = cva(
  [
    'uppercase inline-flex items-center font-semibold select-none justify-center whitespace-nowrap ring-offset-background transition focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
