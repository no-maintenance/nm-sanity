              ...
              >
                ...
                {themeColors.length > 0 && !isInCurrentPath && (
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    ...
                    {baseColor && (
                      <div className={cn(
                        'h-8 w-8 aspect-square rounded-full ring-2',
                        baseColor,
                ...
                {overlayColors.map((color, i) => {
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                            'absolute h-8 w-8 aspect-square rounded-full ring-2 pointer-events-none opacity-60',
                        color,
                ...
                {/* Letter */}
                <span className="relative z-20 text-center text-2xl font-normal leading-normal  text-muted-foreground pointer-events-none">
                  {letter}
                </span>
              </div>
            );
